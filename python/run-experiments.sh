...
export PYTHONPATH=$HOME/code/climate-ae-refac/python:$PYTHONPATH
...
#### re-train linear model and produce plots, using provided model
# python3.7 climate_ae/models/ae/main_generator.py --checkpoint_id='nKGagmsKDb_4249785' --precip=1
